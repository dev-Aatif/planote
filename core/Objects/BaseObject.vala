...
public class Objects.BaseObject : GLib.Object {
    ...
    public Objects.Source ? source {
        get {
            ...
            if (this is Objects.Section) {
                var section = (Objects.Section) this;
                if (section.project != null) {
                    return section.project.source;
                }
                return null;
            }

            if (this is Objects.Item) {
                var item = (Objects.Item) this;
            ...
            if (this is Objects.Reminder) {
                var reminder = (Objects.Reminder) this;
                if (reminder.item != null && reminder.item.project != null) {
                    return reminder.item.project.source;
                }
                return null;
            }
