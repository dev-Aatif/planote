...
public class Utils.Datetime {
    ...
    public static string get_relative_date_from_string (string date) {
        return get_relative_date_from_date (get_date_from_string (date));
    }

    public static string get_default_date_format_from_string (string date) {
        return get_default_date_format_from_date (get_date_from_string (date));
    }
