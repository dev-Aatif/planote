...
public class Dialogs.Preferences.Pages.Accounts : Dialogs.Preferences.Pages.BasePage {
    ...
    public Gtk.Widget build_sync_page () {
        ...
        var label = new Gtk.Label (_("Planote is syncing your tasks, this may take a few moments")) {
            wrap = true,
            halign = Gtk.Align.CENTER,
    ...
    public class SourceRow : Gtk.ListBoxRow {
        ...
        private void show_inbox_warning_dialog () {
            ...
            dialog.choose.begin (Planote._instance.main_window, null, (obj, res) => {
    ...
    public class LoadingPage : Adw.Bin {
        ...
        construct {
            ...
            var primary_label = new Gtk.Label (_("Planote is syncing your tasks, this may take a few moments")) {
                wrap = true,
                halign = CENTER,
                justify = CENTER,
                margin_start = 12,
