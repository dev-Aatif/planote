...
public class Dialogs.Preferences.Pages.Appearance : Dialogs.Preferences.Pages.BasePage {
    ...
    construct {
        ...
        light_row.add_prefix (new Adw.Avatar (32, null, true) {
            custom_image = new Gtk.Image.from_resource ("/io/github/dev_aatif/planote/light-mode.svg").get_paintable (),
        ...
        dark_row.add_prefix (new Adw.Avatar (32, null, true) {
            custom_image = new Gtk.Image.from_resource ("/io/github/dev_aatif/planote/dark-mode.svg").get_paintable (),
            css_classes = { "theme-mode-image" }
        });
        ...
        blue_row.add_prefix (new Adw.Avatar (32, null, true) {
            custom_image = new Gtk.Image.from_resource ("/io/github/dev_aatif/planote/blue-mode.svg").get_paintable (),
            css_classes = { "theme-mode-image" }
        });
