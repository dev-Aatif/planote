...
public class Dialogs.Preferences.Pages.Donate : Dialogs.Preferences.Pages.BasePage {
    ...
    construct {
        ...
        var hero_title = new Gtk.Label (_("Support Planify by alainm23")) {
            css_classes = { "title-2" },
            halign = Gtk.Align.CENTER
        };

        var hero_description = new Gtk.Label (_("Planote is a fork of Planify, the amazing open source task manager created by alainm23. Your donations go directly to the original creator to support continued development. Thank you for supporting open source!")) {
            wrap = true,
        ...
        var thanks_label = new Gtk.Label (_("Thank you for supporting Planify! 🙏")) {
            css_classes = { "title-4" },
            halign = Gtk.Align.CENTER,
            margin_top = 12,
            margin_bottom = 6
        ...
        var thanks_description = new Gtk.Label (_("Your contribution helps alainm23 continue developing Planify and its forks like Planote.")) {
            css_classes = { "caption" },
            halign = Gtk.Align.CENTER,
            margin_bottom = 12
        };
