...
public class Services.ActionManager : Object {
    public Planote app { get; construct; }
    ...
    public ActionManager (Planote app, MainWindow window) {
        Object (
            app: app,
            window: window
        );
    ...
    static construct {
        ...
        action_accelerators.set (ACTION_NEW_NOTE, "<Control>n");
        ...
        action_accelerators.set (ACTION_TOGGLE_FULLSCREEN, "F11");
    ...
    private void action_new_note () {
        // Check if we're currently in a notebook view
        window.new_note_action ();
    }
    ...
    private void action_toggle_fullscreen () {
