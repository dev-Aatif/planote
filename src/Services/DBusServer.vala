...
[DBus (name = "io.github.dev_aatif.planote")]
public class Services.DBusServer : Object {
    private const string DBUS_NAME = "io.github.dev_aatif.planote";
    private const string DBUS_PATH = "/io/github/dev_aatif/planote";
