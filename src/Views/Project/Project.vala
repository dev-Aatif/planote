...
public class Views.Project : Adw.Bin {
    ...
    private void create_context_menu () {
        ...
        var add_note_item = new Widgets.ContextMenu.MenuItem (_("New Note"), "text-editor-symbolic");
        ...
        add_note_item.clicked.connect (() => {
            create_new_note ();
            context_menu.popdown ();
        });
    }

    private void create_new_note () {
        ...
        Services.EventBus.get_default ().send_toast (
            Util.get_default ().create_toast (_("Note created"))
        );
    }
    ...
    private Gtk.Popover build_context_menu_popover () {
        ...
        if (!project.is_deck && !project.inbox_project) {
            ...
            signal_map[archive_item.clicked.connect (() => {
                project.archive_project ((Gtk.Window) Planote.instance.main_window);
            })] = archive_item;

            signal_map[delete_item.clicked.connect (() => {
                project.delete_project ((Gtk.Window) Planote.instance.main_window);
            })] = delete_item;
        }
        ...
        signal_map[paste_item.clicked.connect (() => {
            ...
            clipboard.read_text_async.begin (null, (obj, res) => {
                try {
                    ...
                    Planote.instance.main_window.add_task_action (content);
