public class Widgets.NewVersionPopup : Adw.Bin {
    ...
    construct {
        ...
        description_label = new Gtk.Label (_("Update now to enjoy the latest improvements, bug fixes, and new features that make Planote even better")) {
            wrap = true,
            margin_top = 12,
            margin_bottom = 12,
            xalign = 0
        ...
        update_button.clicked.connect (() => {
            try {
                AppInfo.launch_default_for_uri ("appstream://io.github.dev_aatif.planote", null);
            } catch (Error e) {
